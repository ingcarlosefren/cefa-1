...
#Ejericio 1
#from Modulo3.mcd import mcd
#print(mcd(2366, 273))
#Ejercicio 2
#from Modulo3.exponente import exponente
#print(exponente(65))
#Ejericio 3
#from Modulo3.numeros import panprimo
#print(panprimo(10123456789))
...
def obtener_genero():
    genero = input("Ahora dime tu Genero. Masculo o Femenino?")
    return genero

def obtener_pais_de_nacimiento():
...
def mostrar_perfil(nombre, genero, pais, edad, estatura_m, estatura_cm, num_amigos):
    print("--------------------------------------------------")
    print("Nombre:   ", nombre)
    print("Genero:   ", genero)
...
def obtener_datos():
    n = obtener_nombre()
    e = obtener_edad()
    (esm, esc) = obtener_estatura()
    num_ami = obtener_num_amigos()
    return (n,e,esm,esc,num_ami)
...
pais=obtener_pais_de_nacimiento()
edad = obtener_edad()
(estatura_m, estatura_cm) = obtener_estatura()
num_amigos = obtener_num_amigos()
print("Muy bien,", nombre, ". Entonces podemos crear un perfil con estos datos.")
mostrar_perfil(nombre, genero, pais, edad, estatura_m, estatura_cm, num_amigos)
